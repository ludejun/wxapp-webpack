...
> [!IMPORTANT]
> **This project is pinned to webpack 3, and will not be upgraded.**
>
> [`wxapp-webpack-plugin`](https://www.npmjs.com/package/wxapp-webpack-plugin), which this scaffold
> is built around, stopped at 0.19.0 (2022) with a peer dependency of `webpack ^2 || ^3`. There is
> no webpack 4 or 5 successor. Replacing it would mean rewriting the whole packaging pipeline, which
> is past the point of maintenance.
>
> The project itself **still builds and works** — verified on Node 22 in 2026 — so it remains usable
> as a reference or for a small project. For something new, reach for
> [Taro](https://taro.jd.com/), [uni-app](https://uniapp.dcloud.net.cn/), or the npm support now
> built into the official WeChat devtools.
